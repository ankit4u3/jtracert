 ...
 * standard page sizes.
 * <p>
 * In order to support more page formats (A0, A1 and A2), this class has been
 * slightly modified by Markus Strauch in 11/2007 for the Quick Sequence Diagram
 * Editor project.
 * 
 * @author Charles Loomis
 * @author Mark Donszelmann
 * @version $Id: PageConstants.java,v 1.2 2007/11/20 08:17:41 sdedit Exp $
 */
public class PageConstants {
	...
	// The following page sizes have been added my Markus Strauch
	// for Quick Sequence Diagram Editor
	...
	/**
	 * Value for CUSTOM_PAGE_SIZE and Key for a Dimension object if custom size
	 * is used
	 */
	...
	static {
		...
		sizeTable.put(A1, new Dimension(1684, 2384));
		sizeTable.put(A2, new Dimension(1190, 1684));
